...
public class GraphvizAttrListElementImpl extends ASTWrapperPsiElement implements GraphvizAttrListElement {

  public GraphvizAttrListElementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraphvizElementVisitor visitor) {
    visitor.visitAttrListElement(this);
  }
