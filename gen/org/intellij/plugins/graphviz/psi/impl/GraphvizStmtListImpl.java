...
public class GraphvizStmtListImpl extends ASTWrapperPsiElement implements GraphvizStmtList {

  public GraphvizStmtListImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<GraphvizStmt> getStmtList() {
